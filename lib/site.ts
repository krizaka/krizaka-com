...
export const GITHUB_REPO = "orasaka";

export const SITE_URL = "https://krizaka.com";

export const CONTACT_EMAIL = "bonjour@krizaka.com";

/** Real engine version — keep in sync with the Orasaka monorepo. */
export const ORASAKA_VERSION = "1.0.0-SNAPSHOT";
...
export const MASTER_FEATURES_URL = `${GITHUB_REPO_URL}/blob/main/orasaka-content/docs/MASTER_FEATURES.md`;
