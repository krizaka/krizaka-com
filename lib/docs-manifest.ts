/* ═══════════════════════════════════════════════════════════════════
   Orasaka docs — PUBLICATION MANIFEST
   ─────────────────────────────────────────────────────────────────
   The engine generates many .md files in orasaka-content/docs, several of
...
export const DOCS_MANIFEST: Record<string, DocManifestEntry> = {
  "101": {
    ...
    audience: "developer",
    intro:
      "Stand up Orasaka locally and run your first request in minutes. This onboarding guide is for developers evaluating the engine or wiring it into an application.",
  },
  architecture: {
    ...
    audience: "developer",
    intro:
      "How Orasaka is built: a Ports & Adapters (hexagonal) engine with a curated module topology. Read this to understand the moving parts before going deeper — the interactive 3D model above mirrors the same structure.",
  },
  core: {
  ...
  models: {
    ...
    intro:
      "The models Orasaka has been tested with — local (Ollama) and optional hosted providers. Useful when deciding what you can run entirely on your own infrastructure.",
  },
  api_reference: {
    title: "API Reference",
    category: "api",
    ...
    audience: "developer",
    intro:
      "The HTTP/GraphQL surface for integrating Orasaka into your product. For developers building against the engine.",
  },
  cli: {
    title: "CLI Reference",
    category: "api",
    ...
    audience: "developer",
    intro:
      "Operate and script the engine from the terminal. For developers and operators automating Orasaka.",
  },
  master_features: {
    ...
    audience: "decision-maker",
    intro:
      "A single matrix of what Orasaka can do — chat, RAG, agents, image, audio, video — and the status of each capability. The fastest way to evaluate fit.",
  },
  auth: {
    ...
    audience: "developer",
    intro:
      "How identity, sessions and access control work in Orasaka. For developers securing a deployment.",
  },
  automation: {
    ...
    audience: "developer",
    intro:
      "The automation layer and local agent protocol — how Orasaka plans, calls tools, and acts on your systems. For developers building autonomous workflows.",
  },
  business_implementation: {
    ...
    audience: "decision-maker",
    intro:
      "A practical playbook for turning Orasaka capabilities into outcomes for a business — what to deploy, in what order, and what it delivers. Written for decision-makers, not just engineers.",
  },
  interceptors: {
  ...
  use_cases: {
    ...
    audience: "developer",
    intro:
      "The App-Factory use-cases discovered in the engine, with their capability and domain — generated from the code. For developers extending Orasaka with new products.",
  },
  interface_contracts: {
  ...
  glossary: {
    ...
    audience: "decision-maker",
    intro:
      "Plain-language definitions of the terms used across these docs. A quick reference for anyone evaluating Orasaka.",
  },
};
