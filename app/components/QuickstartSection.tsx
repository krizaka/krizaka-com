...
const COMMANDS = ["npx orasaka install", "npx orasaka start", "npx orasaka dev"];
  ...
  return (
    ...
    >
      ...
      <div style={{ display: "flex", flexWrap: "wrap", gap: "12px", justifyContent: "center", marginTop: "24px" }}>
        <Link href="/products/orasaka" style={{ display: "inline-flex", alignItems: "center", gap: "7px", padding: "11px 20px", borderRadius: "9999px", fontSize: "13px", fontWeight: 600, background: "var(--kz-accent)", color: "var(--kz-on-accent)", textDecoration: "none" }}>
