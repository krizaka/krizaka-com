...
Krizaka Corp operates the Orazaka Core platform — a multi-agent AI orchestration engine. Access is provided on an invitation-only basis during the current deployment phase.
...
1. DATA COLLECTION
We collect only the minimum data necessary to operate our services: anonymized usage telemetry. This site has no sign-up or waitlist forms — no account or email is required to browse it.

2. DATA USE
Collected data is used exclusively for service operation and security monitoring.
...
5. DATA RETENTION
Anonymized telemetry is retained only as long as needed for security and service operation, or until you request deletion.
